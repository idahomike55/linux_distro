...
#Downloads all the packages required to build a linux distro from scratch.
wget https://download.savannah.gnu.org/releases/acl/acl-2.3.1.tar.xz
...
wget https://github.com/gavinhoward/bc/releases/download/6.0.1/bc-6.0.1.tar.xz
...
wget https://downloads.sourceforge.net/project/e2fsprogs/e2fsprogs/v1.46.5/e2fsprogs-1.46.5.tar.gz
...
wget https://prdownloads.sourceforge.net/expat/expat-2.4.8.tar.xz
...
wget https://ftp.gnu.org/gnu/gawk/gawk-5.1.1.tar.xz
...
wget https://ftp.gnu.org/gnu/gzip/gzip-1.12.tar.xz
wget https://github.com/Mic92/iana-etc/releases/download/20220812/iana-etc-20220812.tar.gz
...
wget https://www.kernel.org/pub/linux/utils/net/iproute2/iproute2-5.19.0.tar.xz
wget https://www.kernel.org/pub/linux/utils/kbd/kbd-2.5.1.tar.xz
wget https://www.kernel.org/pub/linux/utils/kernel/kmod/kmod-30.tar.xz
wget https://www.greenwoodsoftware.com/less/less-590.tar.gz
wget https://www.linuxfromscratch.org/lfs/downloads/11.2/lfs-bootscripts-20220723.tar.xz
wget https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.65.tar.xz
wget https://github.com/libffi/libffi/releases/download/v3.4.2/libffi-3.4.2.tar.gz
wget https://download.savannah.gnu.org/releases/libpipeline/libpipeline-1.5.6.tar.gz
...
wget https://download.savannah.gnu.org/releases/man-db/man-db-2.10.2.tar.xz
wget https://www.kernel.org/pub/linux/docs/man-pages/man-pages-5.13.tar.xz
wget https://github.com/mesonbuild/meson/releases/download/0.63.1/meson-0.63.1.tar.gz
...
wget https://github.com/ninja-build/ninja/archive/v1.11.0/ninja-1.11.0.tar.gz
...
wget https://sourceforge.net/projects/procps-ng/files/Production/procps-ng-4.0.0.tar.xz
wget https://sourceforge.net/projects/psmisc/files/psmisc/psmisc-23.5.tar.xz
wget https://www.python.org/ftp/python/3.10.6/Python-3.10.6.tar.xz
wget https://www.python.org/ftp/python/doc/3.10.6/python-3.10.6-docs-html.tar.bz2
wget https://ftp.gnu.org/gnu/readline/readline-8.1.2.tar.gz
wget https://ftp.gnu.org/gnu/sed/sed-4.8.tar.xz
wget https://github.com/shadow-maint/shadow/releases/download/4.12.2/shadow-4.12.2.tar.xz
wget https://www.infodrom.org/projects/sysklogd/download/sysklogd-1.5.1.tar.gz
wget https://download.savannah.gnu.org/releases/sysvinit/sysvinit-3.04.tar.xz
wget https://ftp.gnu.org/gnu/tar/tar-1.34.tar.xz
wget https://downloads.sourceforge.net/tcl/tcl8.6.12-src.tar.gz
wget https://downloads.sourceforge.net/tcl/tcl8.6.12-html.tar.gz
wget https://ftp.gnu.org/gnu/texinfo/texinfo-6.8.tar.xz
wget https://www.iana.org/time-zones/repository/releases/tzdata2022c.tar.gz
wget https://anduin.linuxfromscratch.org/LFS/udev-lfs-20171102.tar.xz
wget https://www.kernel.org/pub/linux/utils/util-linux/v2.38/util-linux-2.38.1.tar.xz
wget https://anduin.linuxfromscratch.org/LFS/vim-9.0.0228.tar.gz
wget https://anduin.linuxfromscratch.org/LFS/wheel-0.37.1.tar.gz
wget https://cpan.metacpan.org/authors/id/T/TO/TODDR/XML-Parser-2.46.tar.gz
wget https://tukaani.org/xz/xz-5.2.6.tar.xz
